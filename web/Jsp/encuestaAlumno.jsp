<%-- 
    Document   : encuestaAlumno
    Created on : 29/11/2013, 05:56:07 AM
    Author     : CARLOS
--%>
...
<html>
    ...
    <td><input type="button" Value="Guardar Encuesta" id="botonIndex" onClick="ActivarTiempo()"/></td>
    <input type="button" Value="Finalizar Encuesta" id="botonIndex" onClick="gracias()"/>
